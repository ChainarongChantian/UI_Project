	...
	public Register() {
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				int res = JOptionPane.showConfirmDialog(Register.this, "Are you sure to closing window?", "Confirm closing", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
		...
		label.setIcon(new ImageIcon("D:\\eclipse JAVA\\workspaceJAVA\\UI_Project\\UI_Project\\src\\Frame\\dadd.png"));
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\eclipse JAVA\\workspaceJAVA\\UI_Project\\UI_Project\\src\\Frame\\eye2.png"));
		...
		btnCancel.setBounds(289, 527, 94, 31);
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!(UserManager.FindUser(user_text.getText().trim()))) {
		...
		btnRegister.setBounds(185, 527, 94, 31);
